...
--CREATE SEQUENCE SEQ_QA_NO NOCACHE NOCYCLE;
--
--INSERT INTO QA (QA_NO, QA_CATE , QA_NAME , QA_CONTENT) VALUES ( SEQ_FAQ_NO.NEXTVAL ,'서비스/이용문의', '서비스이용하는법' , '마이페이지는 어디서 확인할 수 있나요?');
--COMMIT;
--SELECT * FROM QA;
