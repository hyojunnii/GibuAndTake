		...
		<div id="corpJoEvery">
			<div id="logo_name">
				...
				<img id="logo"
					...
					alt="홈페이지 로고"> 
					<span id="siteName">
						<span class="greenBold selected_bg">기부 앤 테이크</span>
						<span id="siteName_small" class="greenBold">Gibu n Take</span>
					</span>
				</a>
			</div>
			...
			<form action="/gibuAndTakePrj/corp/Join" method="post">
				<table>
					<tr>
						...
						<td><input type="text" name="corpId" id="inputId"
							maxlength="10" required="required" placeholder="영문+숫자 4글자 이상"
					...
					<tr>
						...
						<td><input type="password" name="corpPwd" id="input"
							maxlength="10" required placeholder="영문+숫자 4글자 이상"></td>
						<td></td>
					</tr>
					<tr>
						<td class="first" style="font-weight: bold">비밀번호 확인 *</td>
						<td><input type="password" id="input" name="corpPwd2"
							required></td>
						<td></td>
					</tr>
					<tr>
						<td class="first" style="font-weight: bold">대표자명 *</td>
						<td><input type="text" name="rprName" id="input"
							maxlength="3" required></td>
						<td></td>
					</tr>
					<tr>
						<td class="first" style="font-weight: bold">기업명 *</td>
						<td><input type="text" name="corpName" id="input"
							maxlength="3" required></td>
					</tr>
					<tr>
