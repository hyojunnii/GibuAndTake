        ...
        <form action="">
          ...
          <table id="pm-table">
            ...
            <tr>
              ...
              <td colspan="4">
                <input name="" type="text" class="form-control form-content" placeholder="진행자명을 입력하세요." required readonly />
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td colspan="4">
                <input name="" type="text" class="form-control form-content" placeholder="목표 인원을 입력하세요." required />
              </td>
            </tr>
          </table>
          ...
          <div id="form-notice">
            ...
            <p class="form-notice-content">
              ...
              - 카테고리, 진행자명, 제목, 캠페인기간은 수정이 불가능합니다. <br />
