<%@page import="com.gnt.project.vo.FundingVo"%>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>

<% 
	FundingVo fvo = (FundingVo)session.getAttribute("editVo");
%>
...
<html>
  ...
  <body>
    ...
    <div id="body">
      <div id="pm-header">
        <h1><a>펀딩 프로젝트 수정</a></h1>
      </div>
      <div id="pm-form-outer">
        <form action="<%=path%>/pm/edit/funding" method="post">
          <table id="pm-table">
            <tr>
              <td class="form-subtitle">카테고리</td>
              <td colspan="4">
                <select name="category" class="form-select form-content" id="inputGroupSelect01">
                  <option disabled="disabled" selected>${editVo.fundCategory}</option>
                </select>
              </td>
            </tr>
            <tr>
              ...
              <td colspan="4">
                <input value="" name="corp" type="text" class="form-control form-content" placeholder="기업명을 입력하세요." readonly />
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td colspan="4">
                <input value="${editVo.gMoney}" name="gMoney" type="text" class="form-control form-content" placeholder="목표 금액을 입력하세요." required readonly />
              </td>
            </tr>
            <tr>
          ...
          <table id="pm-table2">
              <tr>
                ...
                <td>
                  <input value="${editVo.name[0]}" name="rName" type="text" class="form-control form-content" placeholder="제품명" required />
                </td>
                <td><input value="${editVo.money[0]}" name="rMoney" type="text" class="form-control form-content" placeholder="금액" required /></td>
                <td>
                  <input value="${editVo.count[0]}" name="rCount" type="text" class="form-control form-content" placeholder="수량" required />
                </td>
              </tr>
              <%for(int i = 1; i < (fvo.getName().length); i++) {%>
              	<tr>
	                <td class="form-subtitle" style="width: 23.5%"></td>
	                <td>
	                  <input value="<%=fvo.getName()[i]%>" name="rName" type="text" class="form-control form-content" placeholder="제품명" required />
	                </td>
	                <td><input value="<%=fvo.getMoney()[i]%>" name="rMoney" type="text" class="form-control form-content" placeholder="금액" required /></td>
	                <td>
	                  <input value="<%=fvo.getCount()[i]%>" name="rCount" type="text" class="form-control form-content" placeholder="수량" required />
	                </td>
              	</tr>
              <%}%>
           </table>
          ...
          <div id="form-notice">
            ...
            <p class="form-notice-content">
              ...
              - 카테고리, 기업명, 제목, 목표금액은 수정이 불가능합니다. <br />
              - 펀딩이 시작된 경우 프로젝트 삭제가 불가능합니다. <br />
