...
import com.gnt.qa.service.QaService;
import com.gnt.qa.vo.QaVo;

@WebServlet(urlPatterns = "/qa/list")
...
//		int endPage;			//페이징바의 끝
//		
//		listCount = new QaService().getCount();
//		
...
//		
//		ArrayList<QaVo> voList = new QaService().selectList(pageVo);
