	...
	public MemberVo login(Connection conn ,MemberVo vo) throws Exception {
		...
		try {
			...
			if(rs.next()) {
				...
				loginMember.setMclass(m);
				loginMember.setNum(num);
				...
				loginMember.setEnrolDate(null);
				loginMember.setDelete(delete);
				loginMember.setBan(ban);
				loginMember.setModifyDate(null);
				loginMember.setContent(content);
				loginMember.setCat(cat);
