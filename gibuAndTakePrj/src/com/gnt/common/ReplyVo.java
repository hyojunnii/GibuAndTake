...
public class ReplyVo {
	...
	public ReplyVo(String rep_no, String mno, String regno, String repcontent, String repdate, String repdel,
	...
	public String toString() {
		return "ReplyVo [rep_no=" + rep_no + ", mno=" + mno + ", regno=" + regno + ", repcontent=" + repcontent
